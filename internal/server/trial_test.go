...
// newTestDB is a local helper since outpost has no existing test file
// that defines one.
func newTestDB(t *testing.T) *store.DB {
	t.Helper()
	dir, err := os.MkdirTemp("", "outpost-trial-test-*")
	if err != nil {
